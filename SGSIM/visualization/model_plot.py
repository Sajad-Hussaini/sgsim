...
class ModelPlot:
    ...
    def plot_motion(self, motion_type, id1, id2, **kwargs):
        """
        ...
        kwargs.setdefault('figsize', (14/2.54, 4/2.54))
        with pts.plot_config(**kwargs):
    ...
    def plot_ce(self, **kwargs):
        ...
        if not hasattr(self.sim, 'ce'):
            raise ValueError("""No simulations available.""")
        kwargs.setdefault('figsize', (7/2.54, 6/2.54))
        with pts.plot_config(**kwargs):
            pts.plot_mean_std(self.real.t, self.sim.ce, self.real.ce)
            plt.legend(loc='lower right', frameon=False)
            plt.xlabel('Time (s)', fontsize=kwargs.get('fontsize', 9), family=kwargs.get('font', 'Times New Roman'))
            plt.ylabel(r'Cumulative energy $\mathregular{(g^2.s)}$', fontsize=kwargs.get('fontsize', 9), family=kwargs.get('font', 'Times New Roman'))
            # plt.ticklabel_format(axis='y', style='sci', scilimits=(-3,3))
            plt.show()
        return self

    def plot_fas(self, log_scale=True, **kwargs):
        """
    ...
    def plot_spectra(self, spectrum='sa', log_scale=True, **kwargs):
        """
    ...
    def error_feature(self, feature='mzc', sim_plot=False, **kwargs):
        """
        ...
        kwargs.setdefault('figsize', (10/2.54, 7/2.54))
        with pts.plot_config(**kwargs):
